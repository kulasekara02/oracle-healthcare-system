...
-- PL/SQL Script: OLTP to OLAP Data Load
-- Oracle 19c Compatible
-- ========================================

-- ========================================
-- ETL LOAD PROCEDURE: Initial & Incremental Load
-- ========================================
...
EXECUTE etl_load_healthcare('FULL');

COMMIT;

PROMPT 'ETL Load procedure completed and executed'
